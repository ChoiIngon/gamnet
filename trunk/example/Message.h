...
struct Msg_SS_Echo_Req_Serializer {
	static bool Store(char** _buf_, const Msg_SS_Echo_Req& obj) { return obj.Store(_buf_); }
	static bool Load(Msg_SS_Echo_Req& obj, const char** _buf_, size_t& nSize) { return obj.Load(_buf_, nSize); }
	static int32_t Size(const Msg_SS_Echo_Req& obj) { return obj.Size(); }
};
struct Msg_SS_Echo_Ans {
	enum { MSG_ID = 6 }; 
	std::string	Message;
	Msg_SS_Echo_Ans()	{
	}
...
struct Msg_SS_Echo_Ans_Serializer {
	static bool Store(char** _buf_, const Msg_SS_Echo_Ans& obj) { return obj.Store(_buf_); }
	static bool Load(Msg_SS_Echo_Ans& obj, const char** _buf_, size_t& nSize) { return obj.Load(_buf_, nSize); }
	static int32_t Size(const Msg_SS_Echo_Ans& obj) { return obj.Size(); }
};
#endif // __Message_H__
