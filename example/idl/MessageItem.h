...
struct MsgSvrCli_Item_Ntf_Serializer {
	static bool Store(char** _buf_, const MsgSvrCli_Item_Ntf& obj) { return obj.Store(_buf_); }
	static bool Load(MsgSvrCli_Item_Ntf& obj, const char** _buf_, size_t& nSize) { return obj.Load(_buf_, nSize); }
	static size_t Size(const MsgSvrCli_Item_Ntf& obj) { return obj.Size(); }
};
