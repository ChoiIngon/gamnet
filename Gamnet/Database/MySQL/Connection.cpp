...
namespace Gamnet {	namespace Database { namespace MySQL {
	...
	bool Connection::Connect(const ConnectionInfo& connInfo)
	{
		...
		LOG(INF, "[Gamnet::Database::MySQL] connect...(db_type:", connInfo.db_type_, ", host:", connInfo.uri_, ", port:", connInfo.port_, ", db:", connInfo.db_, ", user:", connInfo.id_, /*", passwd:", connInfo.passwd_, */")");
