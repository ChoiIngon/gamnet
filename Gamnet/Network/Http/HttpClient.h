#ifndef __GAMNET_NETWORK_HTTP_HTTPCLIENT_H__
#define __GAMNET_NETWORK_HTTP_HTTPCLIENT_H__
...
public :
	...
	bool Delete(const char* path, const char* param, std::function<void(int stat, const char* data)> callback);
private :
